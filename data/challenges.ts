...
import { timedButtonPrompts } from "@/data/timedButtonPrompts";
...
export const challenges: Challenge[] = [
  ...
  },
  {
    ...
    difficulty: "brutal",
    tags: ["nonDrinkerSafe", "status", "card"],
    enabled: false,
    baseChance: 0.3,
    minChance: 0.05,
    maxChance: 1,
  ...
  },
  {
    ...
    description: {
      en: "You can only speak in questions for 3 rounds or sip each time you fail.",
      es: "Solo puedes hablar en forma de pregunta durante 3 rondas o tomar 2 cada vez que falles.",
    },
    difficulty: "hard",
    tags: ["nonDrinkerSafe"],
    baseChance: 0.6,
  ...
  },
  {
    ...
    description: {
      en: "Bet drinks on a Drinky racer. Winners gift their bet. Losers drink theirs.",
      es: "Apuesta tragos a una Drinky corredora. Los ganadores reparten su apuesta. Los perdedores beben la suya.",
    },
    difficulty: "normal",
    tags: ["drinking"],
    enabled: true,
  ...
  },
  {
    ...
    description: {
      en: "Complete the prompt before time runs out.",
      es: "Completa la prueba antes de que se acabe el tiempo.",
    },
    difficulty: "normal",
    tags: ["drinking"],
    enabled: true,
    ...
    likes: 0,
    dislikes: 0,
    minigameType: "timedButton",
    timedButtonData: {
      prompts: timedButtonPrompts,
    },
  },
];
